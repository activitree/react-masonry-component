...
class MasonryComponent extends Component {
  static masonry = false
  static erd = undefined
  static latestKnownDomChildren = []
  static displayName = 'MasonryComponent'
  static imagesLoadedCancelRef = undefined
  static masonryContainer = undefined
  ...
  render () {
    ...
    return React.createElement(this.props.elementType, {...props, ref: this.setRef }, this.props.children)
  }
}
